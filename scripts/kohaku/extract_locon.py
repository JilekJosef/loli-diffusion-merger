...
def get_args(text_args):
    ...
    return parser.parse_args(shlex.split(text_args))


from scripts.kohaku.lycoris.utils import extract_diff
from scripts.kohaku.lycoris.kohya.model_utils import load_models_from_stable_diffusion_checkpoint
from scripts.kohaku.lycoris.kohya.sdxl_model_util import load_models_from_sdxl_checkpoint
