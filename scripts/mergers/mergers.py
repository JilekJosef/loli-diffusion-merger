...
def smergegen(weights_a,weights_b,model_a,model_b,model_c,base_alpha,base_beta,mode,
                       calcmode,useblocks,custom_name,save_sets,id_sets,wpresets,tensor,bake_in_vae,opt_value,
                       esettings,
    ...
    result,currentmodel,modelid,theta_0,metadata = smerge(
                        ...
                        useblocks,custom_name,save_sets,id_sets,wpresets,tensor,bake_in_vae,opt_value)
...
def smerge(weights_a,weights_b,model_a,model_b,model_c,base_alpha,base_beta,mode,calcmode,
                useblocks,custom_name,save_sets,id_sets,wpresets,bake_in_vae,opt_value,main = [False,False,False]):
    ...
    mergedmodel =[weights_a,weights_b,
                            ...
                            base_alpha,base_beta,mode,useblocks,custom_name,save_sets,id_sets,calcmode,opt_value].copy()
